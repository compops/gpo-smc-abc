...
for ii in range(nAssets):
    models[:,ii]         = np.matrix( pandas.read_csv('results/example3-portfolio-gposmc-step1-models' + str(ii//5) + '.csv') )[:,ii+1].reshape(3)
...
fileOut.to_csv('results/example3-portfolio-gposmc-var.csv')
